  ...
  const backgrounds = [
    {
      ...
      image:
        "https://i.pinimg.com/736x/03/f0/49/03f0491b0ff49252205090f54468031d.jpg",
    },
    {
      name: "Lord Shiva",
      ...
      image:
        "https://wallpapers.com/images/hd/lord-shiva-hd-statue-under-sunset-wdj1k04xnmc7kmjh.jpg",
    },
    {
      name: "Ganesha",
      ...
      image:
        "https://i.pinimg.com/736x/18/eb/e6/18ebe6c10156f890af2440f5b1b7bc9c.jpg",
    },
    {
      name: "Tempale",
    ...
    },
    {
      ...
      image:
        "https://myindianthings.com/cdn/shop/files/Ram_Ram_Textured_Hanuman_Ji_Wallpaper_b4139c37-3c30-4ad4-9319-bec8935cb28f_1024x.png?v=1711649154",
    },
    {
      name: "Banaras ",
      ...
      image:
        "https://t3.ftcdn.net/jpg/07/16/99/30/360_F_716993097_iUNrir313lTW9L9i7WTwmt4qJ5VmEh8a.jpg",
    },
    {
      name: "Sacred Sunrise",
    ...
    },
    {
      ...
      image:
        "https://radhakelikunj.com/wp-content/uploads/2024/06/DSC07823.jpg",
    },
    {
      ...
      image:
        "https://i.pinimg.com/736x/65/85/b2/6585b2acf606343ce63e24a3ea59ad6e.jpg",
    },
    {
      name: "Mala jaap",
      ...
      image:
        "https://c1.wallpaperflare.com/preview/688/255/681/meditation-bodhi-seeds-mala-spiritual.jpg",
    },
  ];
  ...
  const changeMusic = (index, e) => {
    ...
    if (musicRef.current) {
      ...
      if (soundEnabled) {
        musicRef.current
          .play()
          .catch((e) => console.log("Music change failed:", e));
      }
    }
  };
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0,0,0,${
          darkMode ? 0.6 : 0.3
        }), rgba(0,0,0,${darkMode ? 0.6 : 0.3})), url(${
          backgrounds[selectedBg].image
        })`,
    ...
    >
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-white rounded-full blur-3xl animate-pulse"
            ...
            {activeTab === "backgrounds" ? (
              <div className="space-y-3">
                <p className="text-sm text-gray-400 mb-4">
                  Choose your meditation background ({backgrounds.length}{" "}
                  options)
                </p>
      ...
      <div className="relative z-10 flex flex-col items-center px-4">
        <div
          className={`relative flex items-center justify-center bg-gradient-to-br ${
            darkMode
              ? "from-amber-900/90 to-amber-950/90"
              : "from-amber-800/90 to-amber-900/90"
